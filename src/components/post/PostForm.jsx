...
export default function PostForm({ createPost, onSuccess }) {
  ...
  const handleSubmitForm = async (e) => {
    ...
    if (!message && !file) return toast.error('Error input')
  ...
  return (
    <form onSubmit={handleSubmitForm}>
      <div className="flex flex-col gap-4">
        ...
        />
        {file ? (
          <div className="bg-gray-800 relative" onClick={() => inputEl.current.click()} role="button">
            <img className="mx-auto" alt="post" src={URL.createObjectURL(file)} />
            <div
